# 使用Heroku部署高性能服务，通过ws传输的等协议

> 提醒： 滥用可能导致账户被BAN！！！ 

> 提醒： 将 README.md 中的 Lbingyi 替换为自己的用户名后，再进行部署。 
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/ldj-network/wzfly) 
